...
import { JobStatuses, JobTextStatuses } from "../workflow/constants/job.statuses";
import {lazyModules} from "../../app.routes";
import { TaskSearchRecentProvider } from "./providers/tasks.search.recent.provider";
...
@Component({
    ...
    providers: [
        ...
        {provide: SearchRecentProvider, useClass: TaskSearchRecentProvider},
