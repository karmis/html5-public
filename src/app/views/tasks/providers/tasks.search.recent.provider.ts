...
import { TasksSearchFormProvider } from "./search.form.provider";
...
import {TasksMyComponent} from "../../tasks-my/tasks.my.component";

export class TaskSearchRecentProvider extends SearchRecentProvider {
    selectRecentSearch(recentSearch: RecentModel) {
        ...
        let sfp: TasksSearchFormProvider = (<any>comp.searchFormProvider);
