...
@Component({
    selector: 'production-media-status-component',
...
export class ProductionMediaChangeStatusComponent {
        ...
        this.modalRef.modalEvents.subscribe((e: IMFXModalEvent) => {
            if (e.name === 'save') {
                if(this.mediaStatusControlRef.getSelectedId() == null) {
                    ...
                    this.mediaStatusService.saveMediaStatus(this.row.ID, this.mediaStatusControlRef.getSelectedId()).subscribe((text) => {
