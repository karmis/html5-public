...
import { SegmentingComponent } from './segmenting.component';
import { GLSegmentingComponent } from './gl.component';
...
import { IMFXVersionSegmentsTabModule } from '../../../../modules/search/detail/components/version.segments.tab.component';
...
const routes: Routes = [
    {path: appRouter.empty, component: SegmentingComponent},
];

@NgModule({
    declarations: [
        SegmentingComponent,
        GLSegmentingComponent
    ],
    imports: [
        CommonModule,
