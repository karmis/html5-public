...
export class DetailSegmentComponent {
    /**
     * Detail
     * @type {DetailConfig}
     */
    private detailConfig = <DetailConfig>{
        ...
        options: {
            ...
            needApi: true,
            typeDetails: "segment-details",
            typeDetailsLocal: "segment_details",
            showInDetailPage: true,
            detailsviewType: "-4040",
            friendlyNamesForDetail: 'FriendlyNames.TM_MI_SEG',
            data: {
                detailInfo: <any>null
            },
