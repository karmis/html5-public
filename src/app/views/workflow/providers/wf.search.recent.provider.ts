...
import { WorkflowSearchFormProvider } from "./search.form.provider";
...
export class WorkflowSearchRecentProvider extends SearchRecentProvider {
    selectRecentSearch(recentSearch: RecentModel) {
        const searchModel = recentSearch.getSearchModel();
        const comp: WorkflowComponent = this.config.componentContext;
        ...
        const sfp: WorkflowSearchFormProvider | TasksSearchFormProvider = (<any>comp.searchFormProvider);
