    ...
    function DataView(options) {
        ...
        function debugInfo() {
            return { defaults : defaults
                ...
                , suspend : suspend
                , sortAsc : sortAsc
                , fastSortField : fastSortField
                , sortComparer : sortComparer
                , refreshHints : refreshHints
                , prevRefreshHints : prevRefreshHints
                , filterArgs : filterArgs
                , filteredItems : filteredItems
                , compiledFilter : compiledFilter
                , compiledFilterWithCaching : compiledFilterWithCaching
                , filterCache : filterCache
                , groupingInfoDefaults: groupingInfoDefaults
                , groupingInfos : groupingInfos
                , groups : groups
                , toggledGroupsByLevel : toggledGroupsByLevel
                , groupingDelimiter : groupingDelimiter
        ...
        function endUpdateCustom(diffs) {
            // suspend = false;
            // if (suspend) {
            //     return;
            // }
        ...
        function sort(comparer, ascending) {
            ...
            fastSortField = null;
            //sort always initial list
            items.sort((d1,d2) => d1.id - d2.id);
            if (ascending === false) {
                items.reverse();
            }
            items.sort(comparer);
        ...
        $.extend(this, {
            ...
            "endUpdate": endUpdate,
            "endUpdateCustom": endUpdateCustom,
