...
import { ProductionTableTabComponent } from './production.table.tab.component';
import { MediaTabModule } from '../../../../../views/loan/comps/media-tab';
...
export class ProductionTableTabModule {
}
