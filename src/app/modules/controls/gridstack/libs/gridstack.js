...
(function (factory) {
    ...
    GridStack.prototype._prepareElementsByNode = function (el, node) {
        ...
        var dragOrResize = function (event, ui) {
            var x = Math.round((ui.position.left * 1.025) / cellWidth);// *1.025 is a temporary fix for imfx version of gridstack plugin
            // var x = Math.round((ui.position.left - 0.83333 * cellWidth ) / cellWidth);// *1.025 is a temporary fix for imfx version of gridstack plugin
